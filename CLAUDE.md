...
- **Hooks**: `src/lib/db/hooks.ts` - React hooks and fetch functions for data access
...
- **Local state for drag-drop**: Board and ProjectList use `useState` + `fetchTasks/fetchProjects` for immediate updates during drag operations
